...
The use of do.call / lapply is a powerful way to leverage functional programming in R. Typically you write a function that performs some actions and apply it to a list of inputs, which can then be fed into a function that combines everything into a single object.
...
The use of do.call / lapply provides for a more succinct and distinctive coding style.
