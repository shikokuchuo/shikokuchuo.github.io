...
Below, we demonstrate the inefficiencies of as.data.frame() versus efficient 'data.frame' constructors from the 'ichimoku' package^[Gao, C. (2021), *ichimoku: Visualization and Tools for Ichimoku Kinko Hyo Strategies*. R package version 0.3.51. https://shikokuchuo.net/ichimoku/ CRAN page: https://CRAN.R-project.org/package=ichimoku] coded for performance.
