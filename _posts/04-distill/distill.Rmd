...
4. Create README.md and CNAME in /blog for your Github repository.
<aside> README.md is optional but usual practice. CNAME is a text file containing the domain name if using a custom domain.</aside>
