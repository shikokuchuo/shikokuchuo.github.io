...
Here, I want to recap on some of the little things that have changed since around v0.12 released in January of this year. Things that really improve the quality of life for new and loyal [`mirai`](https://shikokuchuo.net/mirai/) users alike. Sometimes it's these that make the biggest difference, as we strive to take a somewhat thoughtful approach to incoporating new features and requests. I've picked 10 items, in no particular order, with the only proviso being that they are small enough not to merit their own blog post.
