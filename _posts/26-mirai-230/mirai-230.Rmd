...
Developed in collaboration with Joe Cheng (creator of Shiny), it's the only event-driven solution that fully integrates with Shiny's interfaces, and also scales to complex apps with many users [Link to vignette example](https://mirai.r-lib.org/articles/v3-promises.html#shiny-extendedtask-introduction).
