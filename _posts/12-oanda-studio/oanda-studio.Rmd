...
The ichimoku R package^[Gao, C. (2021), *ichimoku: Visualization and Tools for Ichimoku Kinko Hyo Strategies*. R package version 0.3.51, <https://CRAN.R-project.org/package=ichimoku>.] provides tools for creating and visualising Ichimoku Kinko Hyo (cloud chart) strategies.
