...
An implementation of the 'Ichimoku Kinko Hyo' charting system, also commonly known as 'cloud charts' in R.
...
plot(cloud, i = TRUE, from = "2020-05-01", to = "2020-12-03")
iplot(cloud, from = "2020-05-01", to = "2020-12-03", theme = "dark")
```
